 ...
 *
 * @fm_list: Formatted string in which to print the arguments.
 * @fmt : function struts format list
 ...
 *
 * Return: number of intger characters
 *
*/
	...
	int flags, int width, int precision, int size)
{
	...
	fm_item fu_item[] = {
		...
		{'%', printf_percent}, {'i', printf_intger},
		{'d', printf_intger}, {'b', printf_binry},
		{'u', printf_unsigned}, {'o', printf_octal},
		{'x', printf_hexadecimal}, {'X', printf_hexa_upper},
		{'p', printf_pointer}, {'S', print_non_printable},
